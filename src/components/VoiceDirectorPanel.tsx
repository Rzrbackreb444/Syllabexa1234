...
import { Users, Plus, User, Mic2, Trash2, Volume2, Settings2 } from 'lucide-react';
...
const DEFAULT_CHARACTERS: CharacterVoiceMapping[] = [
  { id: 'c-1', characterName: 'Elias', role: 'Protagonist', voiceId: '21m00Tcm4TlvDq8ikWAM', voiceName: 'Rachel', sampleDialogue: 'I never asked for this power. It chose me.' },
  { id: 'c-2', characterName: 'Inspector Vance', role: 'Detective', voiceId: 'AZnzlk1XvdvUeBnXmlld', voiceName: 'Domi', sampleDialogue: 'Just give me the facts. I don\'t deal in myths.' }
];
    ...
    <div className="bg-[#0a0a0d] border border-white/5 rounded-2xl p-5 space-y-5 font-sans">
      <div className="flex items-center justify-between border-b border-white/5 pb-3">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-xs font-mono font-bold uppercase tracking-wider text-white">Voice Director Panel</h3>
            <p className="text-[10px] text-slate-400 font-mono">Assign ElevenLabs neural voices to characters for M4B audiobook generation</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            {isDetecting ? <div className="w-3.5 h-3.5 border-2 border-indigo-400/30 border-t-indigo-400 rounded-full animate-spin" /> : <Settings2 size={14} />} 
            Auto-Detect
          </button>
          <button
